...
let analyse ppf clambda =
  (* let analyse = Absint.analyse clambda in *)
  (* let pure = Purity.unpure_expressions clambda in *)
  (* Cleaner.clean analyse pure clambda *)
  (* ignore (Run_branching.run ppf clambda); *)
  Analysis.run ppf clambda;
  clambda
