...
val check : current_compilation_unit:Flambda.compilation_unit ->
...
val every_used_identifier_is_bound :
  'a Flambda.flambda -> Flambda.variable counter_example

val function_free_variables_are_bound_in_the_closure_and_parameters :
  'a Flambda.flambda -> Flambda.VarSet.t counter_example

val no_identifier_bound_multiple_times :
  'a Flambda.flambda -> Flambda.variable counter_example

val every_bound_variable_is_from_current_compilation_unit :
  current_compilation_unit:Flambda.compilation_unit -> 'a Flambda.flambda ->
  Flambda.variable counter_example
...
val every_declared_closure_is_from_current_compilation_unit :
  current_compilation_unit:Flambda.compilation_unit -> 'a Flambda.flambda ->
  Flambda.compilation_unit counter_example
